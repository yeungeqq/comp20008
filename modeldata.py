...
rating_from_generation.to_csv('results/rating_from_generation.csv')
...
favourite_generation_for_book.to_csv('results/favourite_rating.csv')
...
new_matrix.to_csv('results/new_matrix.csv')
